...
Отображается в UI (`v0.80.0 • build 42`) и в `GET /health` endpoint.
...
Build number инкрементируется при каждом деплое (серверный `.build_number`).

---

## Текущий статус

**Версия:** v0.84 • [Полная история изменений](CHANGELOG.md) (v0.1–v0.84)
