...
import { Film, Music, FileText, Zap, ListOrdered, ChevronDown, Check } from 'lucide-react';
import { isAudioFile, isTranscriptFile } from '@/utils/fileUtils';
...
export function VideoItem({
  ...
  const FileIcon = isTranscript ? FileText : isAudio ? Music : Film;
      ...
      <div className="flex items-start gap-3 mb-3">
        <div
          className={`p-2 rounded-lg flex-shrink-0 ${
            isTranscript ? 'bg-amber-50 text-amber-500' :
