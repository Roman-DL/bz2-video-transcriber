...
**Важно учесть что реализация предыдущих фаз может отличаться от запланированной. Актуальная документация представлена в docs/pipeline. Источником истины является код.**
