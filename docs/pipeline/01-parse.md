...
|-----|-------------|---------|--------|
| Образовательный | `EDUCATIONAL` | Любая тема кроме "История" | `2025.04.07 ПШ.SV. Группа поддержки (Светлана Дмитрук).mp4` |
| Лидерство | `LEADERSHIP` | Тема = `"История"` (на любом типе события) | `2025.04.07 ПШ.SV. История (Антоновы Дмитрий и Юлия).mp4` |
...
- Тема `"История"` → `content_type=LEADERSHIP`
...
**Пример:** `archive/2025/Выездные/Форум TABTeam/История (Иванов Дмитрий)/`
...
- `event_name` для выездных — логическая группировка материалов одного мероприятия
...
- Leadership по теме "История" (одиночный и множественные спикеры)
