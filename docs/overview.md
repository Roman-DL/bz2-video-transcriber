...
| Очистка текста | claude-sonnet-4-6 | Высокое качество, контекст 200K |
| Слайды | claude-haiku-4-5 | Быстро и дёшево для извлечения текста (v0.51+) |
| Longread | claude-sonnet-4-6 | Качественная генерация длинного текста |
| Summary | claude-sonnet-4-6 | Структурированный вывод |
| Story | claude-sonnet-4-6 | Генерация 8 блоков истории |
