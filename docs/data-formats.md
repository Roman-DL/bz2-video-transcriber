...
**Версионирование:**
- Файл содержит поле `version` для совместимости
- При изменении формата несовместимые версии не отображаются
...
```json
{
  ...
  "summary": {
    ...
    "target_audience": "Супервайзеры и консультанты",
    "questions_answered": ["Как проводить Группу поддержки?"],
    "section": "Обучение",
    "subsection": "Работа с командой",
...
| `summary` | object | Структурированное саммари |
