...
| Тип | Действие | Почему |
|-----|----------|--------|
| **Планы** (`docs/plans/`, `docs/superpowers/plans/`) | **Удалить** | Рабочие чеклисты, вся информация в коммитах |
...
Порядок действий:
1. **Планы** — предложить удалить завершённые
...
**Планы:** {удалить X / нет завершённых}
